...
import type { NavItemType, UserInfo, Workspace } from "../types";
...
export function renderNavApp(options: RenderNavAppOptions = {}) {
	...
	const sidebar = (
		<NavSidebar header={sidebarHeader} footer={sidebarFooter}>
	...
	return render(
		<MantineProvider>
			<NavShell header={header} sidebar={sidebar} {...shellProps}>
