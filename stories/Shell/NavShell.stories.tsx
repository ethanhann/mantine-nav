...
import { NavShell, NavSidebar, NavHeader, NavGroup, WorkspaceSwitcher, UserMenu } from '../../src';
import { sampleItems, sampleWorkspaces, sampleUser, sampleUserMenuItems } from '../_data';
...
export const Default: Story = {
  render: () => (
    <NavShell
      header={
        <NavHeader
          logo={<Text fw={700} size="lg">MyApp</Text>}
        />
      }
      sidebar={
        <NavSidebar
    ...
    >
      ...
      <Text c="dimmed">
        This is the main content area. The sidebar uses Mantine AppShell with NavLink components.
      </Text>
    </NavShell>
  ),
};
