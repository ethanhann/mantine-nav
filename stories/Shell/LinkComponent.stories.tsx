...
import { NavShell, NavSidebar, NavHeader, NavGroup } from '../../src';
...
export const WithRouterLink: Story = {
  render: () => (
    <NavShell
      ...
      header={
        <NavHeader
          logo={<Text fw={700} size="lg">SPA App</Text>}
        />
      }
      sidebar={
        <NavSidebar>
    ...
    >
      <Text size="xl" fw={700} mb="md">Dashboard</Text>
      <Text c="dimmed">
        Click sidebar links and check the browser console. Internal links log &quot;SPA navigate to: ...&quot;
        while external links open in a new tab.
      </Text>
      <Text c="dimmed" mt="sm">
        Inspect the DOM — internal links have a <code>data-router-link</code> attribute from the mock component.
      </Text>
    </NavShell>
  ),
};
