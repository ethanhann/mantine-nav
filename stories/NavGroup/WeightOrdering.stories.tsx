...
const weightedItems: NavItemType[] = [
  { id: 'settings', type: 'link', label: 'Settings', href: '/settings', icon: <IconSettings size={18} stroke={1.5} />, weight: 100 },
  { id: 'analytics', type: 'link', label: 'Analytics', href: '/analytics', icon: <IconChartBar size={18} stroke={1.5} />, weight: 20 },
  { id: 'home', type: 'link', label: 'Home', href: '/', icon: <IconHome size={18} stroke={1.5} />, weight: -10 },
  { id: 'customers', type: 'link', label: 'Customers', href: '/customers', icon: <IconUsers size={18} stroke={1.5} />, weight: 30 },
  { id: 'products', type: 'link', label: 'Products', href: '/products', icon: <IconPackage size={18} stroke={1.5} />, weight: 10 },
];
...
const weightedGroup: NavItemType[] = [
  {
    ...
    weight: 10,
    children: [
      { id: 'pricing', type: 'link', label: 'Pricing', href: '/products/pricing', weight: 30 },
      { id: 'catalog', type: 'link', label: 'Catalog', href: '/products/catalog', weight: 10 },
      { id: 'inventory', type: 'link', label: 'Inventory', href: '/products/inventory', weight: 20 },
    ],
  },
  { id: 'home', type: 'link', label: 'Home', href: '/', icon: <IconHome size={18} stroke={1.5} />, weight: -10 },
];
